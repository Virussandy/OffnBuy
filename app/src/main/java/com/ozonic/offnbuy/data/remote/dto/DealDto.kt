...
/**
 * Represents a deal data transfer object from the remote API.
 *
...
data class DealDto(
    ...
    /**
     * Converts this DTO to a [DealEntity] for local storage.
     *
     * @return The [DealEntity] object.
     */
    fun toEntity(): DealEntity {
        return DealEntity(
            deal_id = deal_id,
            discount = discount,
            image = image,
